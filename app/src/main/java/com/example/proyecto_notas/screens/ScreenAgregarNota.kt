...
import com.example.proyecto_notas.componentes.TopBarComponent

//
@Preview
@Composable
fun AgregarNota(navControler : NavController)
{
Scaffold(topBar = { TopBarComponent(Titulo = "NUEVO", navController = navControler) }){
    padding ->
